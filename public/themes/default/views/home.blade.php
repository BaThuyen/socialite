            ...
            <div class="ui-block">
                <div class="widget w-wethear">
                    ...
                    <div class="wethear-now inline-items">
                        ...
                        <svg class="olymp-weather-partly-sunny-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-partly-sunny-icon"></use></svg>
                    </div>
                    ...
                    <ul class="weekly-forecast">
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-sunny-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-sunny-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-cloudy-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-cloudy-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-rain-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-rain-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-storm-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-storm-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-snow-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-snow-icon"></use></svg>
                        ...
                        <li>
                            ...
                            <svg class="olymp-weather-wind-icon-header"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons-weather.svg#olymp-weather-wind-icon-header"></use></svg>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td date-month="12" date-day="23" class="current-day">23</td>
                                    ...
                                    <div class="card-header" role="tab" id="headingOne-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne-1">
                                                Breakfast at the Agency<svg class="olymp-dropdown-arrow-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="card-header" role="tab" id="headingTwo-1">
                                        ...
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
                                                Send the new “Olympus” project files to the Agency<svg class="olymp-dropdown-arrow-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                            </a>
                                        </h5>
                                    </div>
                ...
                <ul class="widget w-friend-pages-added notification-list friend-requests">
                    <li class="inline-items">
                        ...
                        <span class="notification-icon" data-toggle="tooltip" data-placement="top" title="" data-original-title="ADD TO YOUR FAVS">
                            <a href="#">
                                <svg class="olymp-star-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-star-icon"></use></svg>
                            </a>
                        </span>
            ...
            <div class="ui-block">
                <div class="widget w-birthday-alert">
                    <div class="icons-block">
                        <svg class="olymp-cupcake-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-cupcake-icon"></use></svg>
                        <a href="#" class="more"><svg class="olymp-three-dots-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-three-dots-icon"></use></svg></a>
                    </div>
