		...
		<div class="control-block">
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark" data-ps-id="beca4875-2dc1-2deb-b8c6-ae0da67f01e8">
			...
			<div class="control-icon more has-items">
				<svg class="olymp-chat---messages-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-chat---messages-icon"></use></svg>
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark" data-ps-id="6b817e33-f79e-d8c3-8628-db9f357deeda">
					...
					<div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 300px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 192px;"></div></div></div>
			...
			<div class="control-icon more has-items">
				<svg class="olymp-thunder-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-thunder-icon"></use></svg>
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark" data-ps-id="a67afb2d-1662-7dc9-aa4f-686161f54b37">
						<ul class="notification-list">
							<li>
								...
								<div class="notification-event">
									...
									<span class="notification-icon">
										<svg class="olymp-comments-post-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-comments-post-icon"></use></svg>
									</span>
							...
							<li>
								...
								<div class="notification-event">
									...
									<span class="notification-icon">
										<svg class="olymp-heart-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-heart-icon"></use></svg>
									</span>
			...
			<div class="author-page author vcard inline-items more">
				<div class="author-thumb">
					...
					<div class="more-dropdown more-with-triangle">
						<div class="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark" data-ps-id="7d4cdbb6-bca6-531c-c164-e94aab24ee8b">
							<div class="ui-block-title ui-block-title-small">
							...
							<ul class="account-settings">
								<li>
									<a href="29-YourAccount-AccountSettings.html">
										...
										<svg class="olymp-menu-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-menu-icon"></use></svg>
								...
								<li>
									<a href="36-FavPage-SettingsAndCreatePopup.html">
										<svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" title="" data-original-title="FAV PAGE"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-star-icon"></use></svg>
								...
								<li>
									<a href="#">
										<svg class="olymp-logout-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-logout-icon"></use></svg>
							...
							<form class="form-group with-button custom-status">
								...
								<button class="bg-purple">
									<svg class="olymp-check-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-check-icon"></use></svg>
								</button>
						...
						<div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 608px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 536px;"></div></div></div>

					</div>
				</div>
				<a href="02-ProfilePage.html" class="author-name fn">
					<div class="author-title">
						James Spiegel <svg class="olymp-dropdown-arrow-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
					</div>
...
<div class="fixed-sidebar">
    <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
        <a href="{{ url('/') }}" class="logo">
            <img src="{{asset('img/logo.png')}}" alt="Lifebary">
        </a>
        <div class="mCustomScrollbar ps ps--theme_default ps--active-x ps--active-y" data-mcs-theme="dark" data-ps-id="9253421e-ee3a-97d3-de53-f42c637fd54d">
            <ul class="left-menu">
                <li>
                    <a href="#" class="js-sidebar-open">
                        <i class="fa fa-align-left left-menu-icon" aria-hidden="true" data-original-title="OPEN MENU"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/') }}">
                        <i class="fa fa-trophy left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url(Auth::user()->username) }}">
                        <i class="fa fa-id-card left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/'.Auth::user()->username.'/albums') }}">
                        <i class="fa fa-picture-o left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url('messages') }}">
                        <i class="fa fa-comments-o left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url(Auth::user()->username.'/pages') }}">
                        <i class="fa fa-pagelines left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url(Auth::user()->username.'/groups') }}">
                        <i class="fa fa-users left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url(Auth::user()->username.'/saved') }}">
                        <i class="fa fa-cloud left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/'.Auth::user()->username.'/settings/general') }}">
                        <i class="fa fa-cogs left-menu-icon" aria-hidden="true"></i>
                    </a>
                </li>
            </ul>
            <div class="ps__scrollbar-x-rail" style="width: 70px; left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 64px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 602px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 514px;"></div></div></div>
    </div>

    <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
        <a href="{{ url('/') }}" class="logo">
            <img src="{{asset('img/logo.png')}}" alt="Lifebary">
            <h6 class="logo-title">lifebary</h6>
        </a>

        <div class="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark" data-ps-id="53309370-7162-6de8-f783-8870f133194b">
            <ul class="left-menu">
                <li>
                    <a href="#" class="js-sidebar-open">
                        <i class="fa fa-compress left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">Collapse Menu</span>
                    </a>
                </li>
                <li><a href="{{ url('/') }}" class="btn menu-btn">
                        <i class="fa fa-trophy left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.home') }}</span>
                    </a>
                </li>
                <li><a href="{{ url(Auth::user()->username) }}" class="btn menu-btn">
                        <i class="fa fa-id-card left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.my_profile') }}</span>
                    </a>
                </li>
                <li><a href="{{ url('/'.Auth::user()->username.'/albums') }}" class="btn menu-btn">
                        <i class="fa fa-picture-o left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.albums') }}</span>
                    </a>
                </li>
                <li><a href="{{ url('messages') }}" class="btn menu-btn">
                        <i class="fa fa-comments-o left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.messages') }}</span>
                    </a>
                </li>
                <li><a href="{{ url(Auth::user()->username.'/pages') }}" class="btn menu-btn">
                        <i class="fa fa-pagelines left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.pages') }}</span>
                    </a>
                </li>
                <li><a href="{{ url(Auth::user()->username.'/groups') }}" class="btn menu-btn">
                        <i class="fa fa-users left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.groups') }}</span>
                    </a>
                </li>
                <li><a href="{{ url(Auth::user()->username.'/saved') }}" class="btn menu-btn">
                        <i class="fa fa-cloud left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.saved_items') }}</span>
                    </a>
                </li>
                <li><a href="{{ url('/'.Auth::user()->username.'/settings/general') }}" class="btn menu-btn">
                        <i class="fa fa-cogs left-menu-icon" aria-hidden="true"></i>
                        <span class="left-menu-title">{{ trans('common.settings') }}</span>
                    </a>
                </li>
            </ul>
            ...
            <div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 602px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 434px;"></div></div></div>
    </div>
</div>
@if(Auth::guest())
<nav class="navbar socialite navbar-default no-bg guest-nav">
    <div class="container">
        ...
        <nav class="navbar socialite navbar-default no-bg">
            <div class="container-fluid" style="margin: 0; padding: 0; height: 60px">
                @endif
